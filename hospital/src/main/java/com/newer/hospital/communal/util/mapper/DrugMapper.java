...
public interface DrugMapper {
     ...
     * 添加药品
     */
    @Insert("INSERT INTO drug(title,total,`text`,`count`,drugtype_id) VALUES(#{title},#{total},#{text},#{count},#{drugtype.id})")
    ...
    @Update("update drug set count = count + #{count} where id = #{id}")
